...
public class Utils {
    ...
    public static void sendEmail(String url, String subject, String content, User user){
        ...
        try {
            ...
            throw new AppException(HttpStatus.BAD_REQUEST, "Send email failed!");
        }
    ...
    public static Quiz convertToQuizEntity(QuizRequest quizRequest){
        ...
        if(!flag){
            throw new AppException(HttpStatus.BAD_REQUEST, "Không có câu trả lời đúng trong danh sách câu trả lời!");
        }
        return quiz;
    }
}
