...
public class UploadFile {
    ...
    public String uploadFileOnCloudinary(MultipartFile file) {
        try {
            ...
            throw new AppException(HttpStatus.BAD_REQUEST, "Upload file failed!");
        }
    }
    ...
    public void deleteImageInCloudinary(String url){
        try {
            ...
            throw new AppException(HttpStatus.BAD_REQUEST, "Change image failed!");
        }
    }
    ...
    public void deleteVideoInCloudinary(String url){
        try {
            ...
            throw new AppException(HttpStatus.BAD_REQUEST, "Change video failed!");
        }
    }
}
