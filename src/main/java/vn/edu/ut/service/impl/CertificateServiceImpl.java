...
import vn.edu.ut.repository.CertificateRepository;
...
public class CertificateServiceImpl implements CertificateService {
    ...
    public CertificateResponse save(String email, Courses courses) {
        ...
        if (courses.isFinished()) {
            ...
            throw new AppException(HttpStatus.NO_CONTENT, "Khóa học nay chưa kết thúc. Vui lòng chờ cập nhật thêm bài học mới");
        }
